...
import * as turf from '@turf/turf'
  ...
  import raqi_json from './Json/青岛_危害评估.json'
  import marker from './Json/marker.json'
    ...
    methods:{
        ...
        heatMap(){
            ...
            plugins:['AMap.MoveAnimation','AMap.Heatmap','AMap.PlaceSearch','AMap.AutoComplete','AMap.ToolBar', 'AMap.Scale', 'AMap.HawkEye', 'AMap.MapType', 'AMap.Geolocation'],       // 需要使用的的插件列表，如比例尺'AMap.Scale'等
                ...
                var geo_marker = new Loca.GeoJSONSource({
                    zIndex:110,
                    data:this.marker
                });
                labelsLayer.setSource(geo_marker);
