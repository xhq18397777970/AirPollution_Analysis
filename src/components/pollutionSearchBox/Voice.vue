...
<script src="https://cdn.staticfile.org/echarts/4.3.0/echarts.min.js"></script>
  ...
  import $ from 'jquery';
    ...
    export default {
      ...
      watch:{
        voice_ShowOrNot(newValue){
          if(newValue){
            this.voice_show()
            console.log("<PM2.5>按钮开关为：true");
