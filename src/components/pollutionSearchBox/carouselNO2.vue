...
<script src="https://cdn.staticfile.org/echarts/4.3.0/echarts.min.js"></script>
  ...
  import $ from 'jquery';
    ...
    export default {
      ...
      watch:{
        carouselNO2_ShowOrNot(newValue){
          if(newValue){
            this.carousel_no2_show()
            console.log("<NO2>按钮开关为：true");
