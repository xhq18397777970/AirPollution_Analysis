...
<script src="https://cdn.staticfile.org/echarts/4.3.0/echarts.min.js"></script>
  ...
  import $ from 'jquery';
    ...
    export default {
        ...
        props:{
          carouselPM10_ShowOrNot:Boolean,
        },
      data() {
        return {
  ...
  series: [
    ...
    },
    {
      ...
      watch:{
        carouselPM10_ShowOrNot(newValue){
          if(newValue){
            this.carousel_pm10_show()
            console.log("<PM10>按钮开关为：true");
